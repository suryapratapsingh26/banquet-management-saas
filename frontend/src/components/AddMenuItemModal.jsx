...
export default function AddMenuItemModal({ onClose, onSave, existingItem }) {
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input name="name" type="text" value={formData.name} onChange={handleChange} className="w-full mt-1 p-2 border rounded" placeholder="e.g., Paneer Tikka" required />
          </div>
          ...
          <div>
            ...
            <input name="price" type="number" value={formData.price} onChange={handleChange} className="w-full mt-1 p-2 border rounded" placeholder="0.00" required />
          </div>
